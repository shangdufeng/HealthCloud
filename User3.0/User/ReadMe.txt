================================================================================
MICROSOFT 基础类库: User 项目概述
===============================================================================

应用程序向导已为您创建了这个 User 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 User 应用程序的每个文件的内容。
...
User.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CUserApp 应用程序类。

User.cpp
这是包含应用程序类 CUserApp 的主要应用程序源文件。

User.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\User.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 User.rc 中。
...
UserDoc.h，UserDoc.cpp - 文档
这些文件包含 CUserDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CUserDoc::Serialize)。

UserView.h，UserView.cpp - 文档的视图
这些文件包含 CUserView 类。
CUserView 对象用于查看 CUserDoc 对象。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 User.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
